...
let reinhardt = {"id": 22, "firstName": "Reinhardt", "lastName": "Alman", "dob": formatDate("1999-12-11"), "joiningDate": formatDate("1997-09-06") , "gender": "Male", "department": "Fachbereich 2", "email": "Reinal@gmail.com"};
let Hans = {"id": 42, "firstName": "Hans", "lastName": "Müller", "dob": formatDate("2000-06-03"), "joiningDate": formatDate("1997-09-06") , "gender": "Male", "department": "Fachbereich 1", "email": "Hansmüller@gmail.com"};
let Shaytan = {"id": 666, "firstName": "Shaytan", "lastName": "Tidian", "dob": formatDate("1996-06-06"), "joiningDate": formatDate("1997-09-06") , "gender": "Other", "department": "Fachbereich 4", "email": "Ilovewebdevelopment@gmail.com"};
let Mardan = {"id": 27, "firstName": "Mardan", "lastName": "Ali", "dob": formatDate("2000-03-07"), "joiningDate": formatDate("1997-09-06") , "gender": "Male", "department": "Fachbereich 3", "email": "madamardan@gmx.de"};
let Dilara = {"id": 31, "firstName": "Dilara", "lastName": "Anne", "dob": formatDate("1997-09-06"),"joiningDate": formatDate("1997-09-06") , "gender": "Female", "department": "Fachbereich 5", "email": "Dilara69@hotmail.de"};

staffLogin.push(reinhardt)
staffLogin.push(Hans)
staffLogin.push(Shaytan)
staffLogin.push(Mardan)
staffLogin.push(Dilara)
